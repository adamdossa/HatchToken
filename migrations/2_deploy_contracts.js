...
module.exports = async function(deployer, network, accounts) {
  await deployer.deploy(LockedToken, "Hatchtoken", "HATCH", BigNumber(18), web3.utils.toBN(String(1000000000)), accounts[1], web3.utils.toWei(String(200000000)), web3.utils.toBN(String(13300000)));
